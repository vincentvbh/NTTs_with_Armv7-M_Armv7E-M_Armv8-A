...
twistTable     = map (\x -> cmod x q) (converToTable                omega4     omega9 [1 .. 8])
...
moreTables = omega9Table
    ...
    ++ twistTable ++ twistRmodTable ++ invTwistRmodTable
...
twistTableSymbol     = map (\x -> converToTableSymbol x    "omega4omega9" "Q1") [1 .. 8]
...
moreTableSymbols = omega9TableSymbol
    ...
    ++ twistTableSymbol ++ twistRmodTableSymbol ++ invTwistRmodTableSymbol

...
// 7
.macro doublemontgomery_mul_16 tb, a, twiddle, QQprime, tmp, tmp2
    smulb\tb \tmp, \a, \twiddle
...
// 28
.macro doublemontgomery_mul_16_4 tb, c0, c1, c2, c3, multiplier, QQprime, tmp, tmp2
    doublemontgomery_mul_16 \tb, \c0, \multiplier, \QQprime, \tmp, \tmp2
    doublemontgomery_mul_16 \tb, \c1, \multiplier, \QQprime, \tmp, \tmp2
    doublemontgomery_mul_16 \tb, \c2, \multiplier, \QQprime, \tmp, \tmp2
    doublemontgomery_mul_16 \tb, \c3, \multiplier, \QQprime, \tmp, \tmp2
.endm

// 56
.macro doublemontgomery_mul_16_8 tb, c0, c1, c2, c3, c4, c5, c6, c7 multiplier, QQprime, tmp, tmp2
    doublemontgomery_mul_16 \tb, \c0, \multiplier, \QQprime, \tmp, \tmp2
    doublemontgomery_mul_16 \tb, \c1, \multiplier, \QQprime, \tmp, \tmp2
    doublemontgomery_mul_16 \tb, \c2, \multiplier, \QQprime, \tmp, \tmp2
    doublemontgomery_mul_16 \tb, \c3, \multiplier, \QQprime, \tmp, \tmp2
    doublemontgomery_mul_16 \tb, \c4, \multiplier, \QQprime, \tmp, \tmp2
    doublemontgomery_mul_16 \tb, \c5, \multiplier, \QQprime, \tmp, \tmp2
    doublemontgomery_mul_16 \tb, \c6, \multiplier, \QQprime, \tmp, \tmp2
    doublemontgomery_mul_16 \tb, \c7, \multiplier, \QQprime, \tmp, \tmp2
.endm

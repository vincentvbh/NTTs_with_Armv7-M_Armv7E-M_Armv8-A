...
static const  int16_t __attribute__((aligned (4))) streamlined_CT_negacyclic_table_Q1[((NTT_N - 1) / 7) << 3] = {
...
static const int16_t __attribute__((aligned (4))) streamlined_CT_negacyclic_table_Q2[((NTT_N - 1) / 7) << 3] = {
...
static const int16_t __attribute__((aligned (4))) mul_Rmod_table_Q1[NTT_N >> 1] = {
...
static const int16_t __attribute__((aligned (4))) mul_Rmod_table_Q2[NTT_N >> 1] = {
...
extern void __asm_negacyclic_ntt_32(int32_t *des, const int32_t *root_table, int32_t Qprime, int32_t Q, uint16_t *src);
extern void __asm_negacyclic_ntt_16(int16_t *des, const int16_t *root_table, int32_t QQprime, uint16_t *src, int32_t RmodQ);
extern void __asm_negacyclic_ntt_16_light(int16_t *des, const int16_t *root_table, int32_t QQprime, uint16_t *src, int32_t RmodQ);
extern void __asm_mod(int16_t *des, int32_t QQprime, int32_t *src);
extern void __asm_mod_dual(int16_t *des1, int16_t *des2, int32_t _Q1Q1prime, int32_t _Q2Q2prime, int32_t *src);
extern void __asm_base_mul_32(int32_t *des, const int32_t *mul_Rmod_table, int32_t Qprime, int32_t Q, int32_t *src1, int32_t *src2);
extern void __asm_base_mul_acc_32(int32_t *des, const int32_t *mul_Rmod_table, int32_t Qprime, int32_t Q, int32_t *src1, int32_t *src2);
extern void __asm_base_mul_16(int16_t *des, const int16_t *mul_Rmod_table, int32_t QQprime, int16_t *src1, int16_t *src2);
extern void __asm_base_mul_32x16(int16_t *des, const int16_t *mul_Rmod_table, int32_t QQprime, int32_t *src_32, int16_t *src_16);
extern void __asm_solv_CRT_32_m4(int32_t *des, int16_t *src1, int16_t *src2, const int32_t *_final_constants);
extern void __asm_negacyclic_intt_32(uint16_t *des, const int32_t *root_table, int32_t Qprime, int32_t Q, int32_t *src);
...
#define NTT_mul_acc_32(out, in1, in2) __asm_base_mul_acc_32(out, mul_Rmod_table_Q1Q2, Q1Q2prime, Q1Q2, in1, in2)

...
// ================================
    ...
    NTT_inv(poly_NTT_out_int16, res_NTT);
...
// ================================
    ...
    oldcount = hal_get_time();
    __asm_i_3x2(res_NTT, _3_iNTT_Rmod_table_Q1, Q1prime, Q1);
...
// ================================
    ...
    oldcount = hal_get_time();
    __asm_final_map(poly_NTT_out_int16, final_const, Q1prime, Q1, res_NTT);
    newcount = hal_get_time();
